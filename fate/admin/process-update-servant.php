...
$FILTRES_SERVANT = array(
    'idServant' => FILTER_SANITIZE_NUMBER_INT,
...
if ($_FILES['face']['size'] > 500000 || $_FILES['face']['size'] > 500000) {
    ...
    if (move_uploaded_file($sourceFile1, $fileDestination1) && move_uploaded_file($sourceFile2, $fileDestination2) || $extensionFile1 == "" || $extensionFile2 == "") {
        ...
        $updateSuccesful = ServantDAO::updateServant($servant, $face, $image);

        if ($updateSuccesful) {
            echo "Your servant was updated";
        }
    } else {
        echo "Failed";
    }
